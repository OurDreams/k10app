...
#define BOARD_ST407     (5u)
#define BOARD_MK10D     (6u)

#define BOARD_BUILD_VER BOARD_MK10D
...
#elif (BOARD_BUILD_VER == BOARD_ST407)
# include "./board/discovery/boardcfg.h"
#elif (BOARD_BUILD_VER == BOARD_MK10D)
# include "./board/mk10d/boardcfg.h"
