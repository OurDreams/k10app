...
void    gpio_init  (PORTx, uint8_t n,GPIO_CFG,uint8_t data);    //初始化gpio

void    gpio_set   (PORTx,  uint8_t n,     uint8_t data);                                                 //设置引脚状态
void    gpio_turn  (PORTx,  uint8_t n);                                                              //翻转引脚状态
uint8_t      gpio_get   (PORTx,  uint8_t n);                                                              //读取引脚状态
