...
extern uint16_t      ad_once   (ADCn,ADC_Ch,ADC_nbit);      //采集一次一路模拟量的AD值

extern uint16_t      ad_mid    (ADCn,ADC_Ch,ADC_nbit);      //中值滤波后的结果
extern uint16_t      ad_ave    (ADCn,ADC_Ch,ADC_nbit,uint8_t N); //均值滤波后的结果
